    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          paragraphs: [
            'Lunidex uses strictly necessary storage for the service. With your consent, Vercel Web Analytics and Speed Insights measure audience and performance, while Neon stores only daily product-measurement counters. See our cookie policy for the separate purposes and choices.',
          ],
          list: [
  ...
  sections: [
    {
      ...
      intro: 'Lunidex uses strictly necessary storage for the service. Vercel audience and performance measurement and Neon product measurement remain disabled until you grant the corresponding consent.',
      table: {
    ...
    },
    {
      ...
      list: [
        'Vercel Web Analytics and Speed Insights are loaded only after audience and performance consent; Neon receives only daily aggregated product counters after separate product-measurement consent.',
    ...
    },
    {
      ...
      list: [
        ...
        'By clearing browsing data for the site lunidex.app.',
