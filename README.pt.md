...
O workflow CI em [`.github/workflows/ci.yml`](./.github/workflows/ci.yml) instala as dependências e executa lint, verificações de tipos web/core, o build de produção e a verificação de tipos mobile.
