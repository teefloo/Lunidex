...
export type { TCGCardLanguage } from '@primedex/core/lib/tcg-language';
export type {
  TCGCollection,
...
export type { TCGDisplayCurrency } from '@primedex/core/lib/tcg-currency';
...
export interface TCGCollectionCard {
  ...
  image?: string;
  rarity?: string | null;
  variants?: TCGCardVariants | null;
  variantValues?: Partial<Record<'normal' | 'reverse' | 'holo', TCGCardValue | null>>;
