...
export function HomeCollectionEntry({ className, locale, startLabel, resumeLabel }: HomeCollectionEntryProps) {
  ...
  return (
    <Link
      ...
      className={className ?? 'inline-flex min-h-12 min-w-56 items-center justify-center gap-2 rounded-sm border border-primary/45 bg-primary/10 px-5 text-sm font-black uppercase tracking-[0.1em] text-primary transition-colors hover:bg-primary/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60'}
    >
