    ...
    <section className="rounded-sm border border-border/70 bg-card/35 p-5">
      <div className="mb-4 flex items-center gap-2">
        ...
        <div>
          ...
          <p className="mt-0.5 text-[10px] text-foreground/30">{subtitle}</p>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="relative mb-1">
        <span className="absolute -left-1 -top-1 flex h-4 w-4 items-center justify-center rounded-full bg-primary/90 text-[8px] font-black text-primary-foreground">
          {rank}
        </span>
      ...
      <span className="w-full truncate text-[10px] font-bold text-foreground/60 group-hover:text-foreground">
        {pokemon.localizedName}
      </span>
      <span className="mt-0.5 text-[10px] font-black text-primary/80">{pokemon.statValue}</span>
