...
const COLLECTION_KEYS = [
  ...
  'selectedColors', 'selectedShapes', 'viewedTypes',
...
/** Normalize old snapshots and rebuild the compatibility index. */
...
function resolveCollection(
  ...
  return Object.keys(entries)
    ...
    .flatMap((id) => {
      ...
      // The identity stamp decides which quantity survives. Do not let the
      // remote array's iteration order overwrite a local value that won the
      // existing last-writer clock.
