  ...
  privacy: {
    ...
    sections: [
      { id: 'account-data', title: '1. Compte et données personnelles', paragraphs: [
        ...
        'Une fois connecté, votre espace personnel peut synchroniser avec Neon les données que vous choisissez d’utiliser : favoris, Pokémon capturés, équipes, comparaisons, progression, quiz, collection et listes TCG, notes, recherches sauvegardées, réglages et autres fonctions associées. Les profils publics, amis, alertes de prix, salons de combat et notifications ne sont traités que si vous utilisez ces fonctions.',
