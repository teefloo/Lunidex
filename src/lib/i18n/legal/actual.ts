...
const updatedEn = 'September 9, 2026';
...
const fr: LegalDocuments = {
  privacy: {
    ...
    sections: [
      ...
      { id: 'bases', title: '2. Finalités et bases légales', table: { headers: ['Traitement', 'Base légale'], rows: [
        ...
        ['Mesure d’audience, performance Sentry et mesures produit Neon/PostHog', 'Consentement préalable et distinct pour les mesures facultatives, retirable à tout moment (article 6.1.a du RGPD).'],
      ...
      { id: 'local-storage', title: '3. Stockage dans le navigateur', paragraphs: [
        'Le navigateur conserve des éléments nécessaires à l’expérience : la langue choisie (cookie primedex-lang), le choix de consentement (localStorage primedex-consent-v2 et cookie technique de consentement PostHog), des marqueurs de session de mesure et un cache local de réponses publiques PokéAPI/TCGdex. Ces caches ne constituent pas votre espace personnel synchronisé.',
      ...
      { id: 'measurement', title: '4. Mesure, logs et données techniques', paragraphs: [
        'Vercel Web Analytics, Speed Insights et le tracing navigateur ou Session Replay Sentry ne sont activés qu’après votre consentement distinct « audience et performance ». Le replay masque les textes et champs de saisie, bloque les zones marquées et n’enregistre ni les en-têtes ni les corps réseau. La mesure produit Neon et PostHog est également facultative : si vous l’autorisez, Lunidex envoie à Neon uniquement des événements TCG prédéfinis pour des compteurs agrégés, et à PostHog des vues de page normalisées, des événements métier explicites, des erreurs et des métriques de performance avec des propriétés limitées. Après authentification, PostHog peut utiliser l’identifiant technique stable du compte pour relier la session anonyme au compte ; l’e-mail, le nom et les secrets ne sont pas envoyés, et l’identité est réinitialisée à la déconnexion.',
        'Lunidex utilise aussi Sentry pour la surveillance des erreurs et de la disponibilité. Le SDK n’envoie pas les données personnelles par défaut et Lunidex supprime les paramètres d’URL, cookies, en-têtes et corps de requête avant l’envoi. Vous pouvez aussi envoyer volontairement à Sentry un message décrivant un problème depuis le pied de page et choisir d’y joindre une capture d’écran ; ce formulaire ne demande ni nom ni adresse e-mail et la capture n’est jamais prise automatiquement. L’infrastructure et les protections anti-abus peuvent traiter des informations techniques de requête, comme l’adresse IP, l’URL, l’horodatage et le code de réponse. Le code de la route de contact valide et limite les requêtes mais ne stocke ni ne journalise le contenu du message.',
      ] },
      { id: 'recipients', title: '5. Services, destinataires et transferts', paragraphs: [
        'Neon fournit l’authentification et les données applicatives lorsque ces variables sont configurées. Vercel héberge et distribue l’application. Sentry reçoit les événements techniques d’erreur et, avec consentement, les données de performance et de replay protégées par les réglages de confidentialité ci-dessus. PostHog reçoit, avec consentement, les données de mesure produit décrites ci-dessus. Resend reçoit les informations nécessaires à l’envoi des messages du formulaire (adresse e-mail, nom, sujet et contenu). PokéAPI, TCGdex et les hébergeurs d’images fournissent des données publiques demandées par l’application. Chaque fournisseur peut traiter des données techniques selon ses propres conditions.',
        'Resend, Sentry, PostHog et Vercel peuvent traiter des données aux États-Unis ou dans d’autres pays selon leur configuration. Les transferts sont encadrés par les garanties publiées par les prestataires, notamment leurs accords de traitement et mécanismes de transfert applicables. Consultez leurs politiques et accords : https://resend.com/legal/dpa, https://sentry.io/legal/dpa/, https://posthog.com/privacy et https://vercel.com/legal/dpa.',
      ...
      { id: 'retention', title: '6. Durées de conservation', table: { headers: ['Catégorie', 'Durée'], rows: [
        ...
        ['Mesure produit Neon et PostHog', 'Compteurs Neon journaliers agrégés conservés pendant 90 jours ; les données PostHog suivent la conservation configurée dans le projet PostHog.'],
      ...
      { id: 'rights', title: '7. Vos droits et contact', paragraphs: [
        ...
        'Vous pouvez refuser ou retirer séparément les mesures Vercel, Sentry, Neon et PostHog depuis le bandeau de consentement ou le bouton « Gérer mes préférences » du pied de page. Le retrait empêche les intégrations concernées de capturer de nouvelles données et supprime les marqueurs de mesure locaux prévus par l’application.',
  ...
  terms: {
    ...
    sections: [
      ...
      { id: 'property', title: '3. Sources et propriété intellectuelle', paragraphs: ["Lunidex est un projet de fans indépendant. Pokémon et les éléments associés restent la propriété de Nintendo, Game Freak, Creatures Inc. et The Pokémon Company. Le code source original de Lunidex est publié sous licence MIT dans le dépôt ; la licence MIT s'applique uniquement au code original et aux éléments du projet pour lesquels le titulaire des droits peut accorder une licence, et ne couvre pas les marques Pokémon, illustrations, images, données de jeu ni les autres contenus tiers."] },
  ...
  cookies: {
    ...
    preamble: 'Les intégrations de mesure facultative sont initialisées avec la collecte désactivée et ne capturent aucune donnée avant votre choix. Vous pouvez modifier ou retirer ce choix à tout moment.',
    lastUpdated: updated,
    effectiveDate: updated,
    sections: [
      { id: 'inventory', title: '1. Éléments nécessaires et facultatifs', table: { headers: ['Élément', 'Finalité', 'Durée indicative'], rows: [['primedex-lang', 'Mémoriser la langue choisie', '1 an'], ['primedex-consent-v2', 'Mémoriser les choix de mesure', 'Jusqu’à modification ou suppression'], ['primedex-product-measurement-consent', 'Permettre au serveur de respecter le choix PostHog', '1 an ou jusqu’au retrait'], ['Cookies Neon Auth', 'Maintenir la session de compte', 'Selon la configuration Neon Auth'], ['Sentry error monitoring', 'Surveillance technique des erreurs et de la disponibilité', 'Selon la configuration de conservation Sentry'], ['Vercel Web Analytics, Speed Insights et Sentry performance/replay', 'Mesure d’audience et de performance après consentement', 'Après consentement, selon la configuration des fournisseurs'], ['Mesure produit Neon et PostHog', 'Compteurs TCG, vues de page, événements explicites, erreurs et performances après consentement', 'Selon les configurations des fournisseurs']] } },
      ...
      { id: 'measurement', title: '3. Mesure facultative', paragraphs: ['Vercel Web Analytics, Speed Insights et le tracing ou replay navigateur Sentry sont chargés uniquement si vous accordez le choix « audience et performance ». Neon reçoit une mesure produit TCG limitée et agrégée, et PostHog reçoit des vues de page normalisées, des événements explicites, des erreurs et des performances limitées si vous accordez le choix distinct « mesure produit ». PostHog utilise alors une identité technique persistante nécessaire à la continuité anonyme → compte ; elle ne contient pas l’e-mail ou le nom, est réinitialisée à la déconnexion et est supprimée de la collecte lorsque le consentement est retiré. Le replay est échantillonné, masque les champs et textes sensibles, bloque les zones marquées et exclut les corps et en-têtes réseau. Aucun de ces choix n’est nécessaire pour consulter les pages publiques.'] },
...
const en: LegalDocuments = {
  privacy: {
    ...
    sections: [
      ...
      { id: 'bases', title: '2. Purposes and legal bases', table: { headers: ['Processing', 'Legal basis'], rows: [['Account, authentication and synchronization', 'Performance of the requested service and pre-contractual steps when you create an account (GDPR Article 6(1)(b)).'], ['Contact requests', 'Legitimate interest in answering your request; legal obligation when you exercise a right (GDPR Article 6(1)(f) or 6(1)(c)).'], ['Vercel audience measurement, Sentry performance, and Neon/PostHog product measurement', 'Separate prior consent for optional measurement, which can be withdrawn at any time (GDPR Article 6(1)(a)).'], ['Security, abuse prevention and availability', 'Legitimate interest in securing and maintaining the service (GDPR Article 6(1)(f)).'], ['Push notifications', 'Consent given when enabling the feature and permission from your browser or device.']] } },
  ...
  terms: {
    ...
    sections: [
      ...
      { id: 'property', title: '3. Sources and intellectual property', paragraphs: ['Lunidex is an independent fan project. Pokémon and related elements remain the property of Nintendo, Game Freak, Creatures Inc. and The Pokémon Company. Lunidex’s original source code is released under the MIT License in the repository; the MIT License applies only to original Lunidex code and project materials for which the copyright holder can grant rights, and does not cover Pokémon marks, artwork, imagery, game data or other third-party content.'] },
  ...
  cookies: {
    ...
    preamble: 'Optional measurement integrations initialize with collection disabled and capture no data before you choose. You can change or withdraw your choice at any time.',
    lastUpdated: updatedEn,
    effectiveDate: updatedEn,
    sections: [
      { id: 'inventory', title: '1. Necessary and optional elements', table: { headers: ['Element', 'Purpose', 'Indicative lifetime'], rows: [['primedex-lang', 'Remember the selected language', '1 year'], ['primedex-consent-v2', 'Remember measurement choices', 'Until changed or deleted'], ['primedex-product-measurement-consent', 'Let the server respect the PostHog choice', '1 year or until withdrawn'], ['Neon Auth cookies', 'Maintain the account session', 'According to Neon Auth configuration'], ['Sentry error monitoring', 'Technical error and availability monitoring', 'According to Sentry retention settings'], ['Vercel Web Analytics, Speed Insights and Sentry performance/replay', 'Audience and performance measurement after consent', 'After consent, according to provider settings'], ['Neon and PostHog product measurement', 'TCG counters, pageviews, explicit events, errors and performance after consent', 'According to provider settings']] } },
      ...
      { id: 'measurement', title: '3. Optional measurement', paragraphs: ['Vercel Web Analytics, Speed Insights and Sentry browser tracing or Session Replay load only if you grant the audience and performance choice. Replay masks text and inputs, blocks marked areas, and excludes network bodies and headers. The PostHog SDK is initialized opted out and sends no data before consent. Neon receives limited, aggregated TCG product measurement, and PostHog receives normalized pageviews, explicit events, limited errors and performance data if you grant the separate product measurement choice. PostHog then uses a consent-gated persistent technical identity for anonymous → account continuity; it does not receive the email or name, and it resets on logout. Replay is sampled and privacy-marked UI is blocked. Neither choice is required for public pages.'] },
