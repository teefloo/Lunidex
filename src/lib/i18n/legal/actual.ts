...
const fr: LegalDocuments = {
  privacy: {
    ...
    sections: [
      ...
      { id: 'measurement', title: '4. Mesure, logs et données techniques', paragraphs: [
        'Vercel Web Analytics, Speed Insights et le tracing navigateur ou Session Replay Sentry ne sont activés qu’après votre consentement distinct « audience et performance ». Le replay masque les textes et champs de saisie et bloque les médias. La mesure produit Neon et PostHog est également facultative : si vous l’autorisez, Lunidex envoie à Neon uniquement des événements TCG prédéfinis pour des compteurs agrégés, et à PostHog des vues de page normalisées ainsi que ces événements TCG avec des propriétés limitées. Les données PostHog ne sont pas reliées à user_state ni à votre compte.',
  ...
  cookies: {
    ...
    effectiveDate: updated,
    sections: [
      { id: 'inventory', title: '1. Éléments nécessaires et facultatifs', table: { headers: ['Élément', 'Finalité', 'Durée indicative'], rows: [['primedex-lang', 'Mémoriser la langue choisie', '1 an'], ['primedex-consent-v2', 'Mémoriser les choix de mesure', 'Jusqu’à modification ou suppression'], ['Cookies Neon Auth', 'Maintenir la session de compte', 'Selon la configuration Neon Auth'], ['Sentry error monitoring', 'Surveillance technique des erreurs et de la disponibilité', 'Selon la configuration de conservation Sentry'], ['Vercel Web Analytics, Speed Insights et Sentry performance/replay', 'Mesure d’audience et de performance après consentement', 'Après consentement, selon la configuration des fournisseurs'], ['Mesure produit Neon et PostHog', 'Compteurs TCG et vues de page normalisées après consentement', 'Selon les configurations des fournisseurs']] } },
...
const en: LegalDocuments = {
  ...
  cookies: {
    ...
    sections: [
      ...
      { id: 'measurement', title: '3. Optional measurement', paragraphs: ['Vercel Web Analytics, Speed Insights and Sentry browser tracing or Session Replay load only if you grant the audience and performance choice. Replay masks text and inputs and blocks media. The PostHog SDK is initialized opted out and sends no data before consent. Neon receives limited, aggregated TCG product measurement, and PostHog receives normalized pageviews and limited TCG events, if you grant the separate product measurement choice. PostHog does not set an analytics cookie or retain a persistent analytics identity in the Lunidex integration; the site still stores the consent state locally. Neither choice is required for public pages.'] },
