...
const privacy: LegalDocument = {
  ...
  intro:
    'This policy describes how we process your personal data when you use PrimeDex, in compliance with the General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA).',
  preamble:
    "PrimeDex is a non-commercial, fan-made website not affiliated with Nintendo, Game Freak, The Pokémon Company, or Creatures Inc. We take the protection of your privacy very seriously. This policy explains, in full transparency, what data is collected, why, how it is used, how long it is kept, and what your rights are.",
  ...
  sections: [
    {
      ...
      paragraphs: [
        "PrimeDex is published by an individual on a personal, non-commercial basis. There is no legal entity, no company registration number, and no separate legal representative.",
      ...
      table: {
        ...
        rows: [
          ['Publisher (Data Controller)', 'Individual — PrimeDex', 'estdel3012@gmail.com'],
    ...
    },
    {
      ...
      intro: 'PrimeDex collects only the minimum data necessary to operate the service.',
      subsections: [
        {
          id: 'data-personal',
        ...
        },
        {
          ...
          paragraphs: [
            'Upon any connection to PrimeDex, your browser automatically exchanges technical information with our infrastructure and our processors. This data is strictly necessary for the establishment and proper operation of the communication:',
          ],
          table: {
    ...
    },
    {
      ...
      paragraphs: [
        'PrimeDex does not sell, rent, or transfer any personal data to third parties for commercial or marketing purposes. No profiling or automated decision-making producing legal effects is performed.',
      ],
      table: {
    ...
    },
    {
      ...
      title: '7. Security',
      paragraphs: [
        'PrimeDex implements appropriate technical and organizational measures to protect your data against unauthorized access, modification, disclosure, or destruction.',
      ],
      list: [
    ...
    },
    {
      ...
      paragraphs: [
        'PrimeDex is aimed at a family audience and may be consulted by minors. The site does not knowingly collect any personal data from children under 16 (or the applicable age under local law) without parental consent.',
    ...
    },
    {
      ...
      paragraphs: [
        'PrimeDex relies on third-party APIs and services to provide the displayed data (PokéAPI, TCGdex, Scrydex, GitHub). These services have their own privacy policies, which we encourage you to consult.',
...
const terms: LegalDocument = {
  ...
  intro:
    "These terms of service (TOS) govern your access to and use of PrimeDex. By accessing the site, you agree to be bound by these terms.",
  preamble:
    'PrimeDex is a personal, free, ad-free, non-monetized fan project. It is provided "as is", for entertainment and information purposes about the Pokémon universe. Any use of the site constitutes acceptance of these TOS.',
  lastUpdated: 'June 4, 2026',
  effectiveDate: 'June 4, 2026',
  sections: [
    {
      ...
      title: '1. Purpose',
      paragraphs: [
        'PrimeDex is a non-commercial website cataloging data related to Pokémon (numbers, types, statistics, descriptions, evolutions, abilities, sprites) and to the Trading Card Game (TCG) cards of the same universe. It is a fan project for purely informational and recreational purposes.',
    ...
    },
    {
      ...
      intro: 'PrimeDex is in no way affiliated with, sponsored by, supported by, or approved by:',
      list: [
        'Nintendo Co., Ltd.',
        'Game Freak Inc.',
        'Creatures Inc.',
      ...
      paragraphs: [
        'Trademarks, names, sprites, illustrations, sounds, videos, and any other content related to the Pokémon universe remain the exclusive property of their respective rights holders. PrimeDex claims no ownership of them.',
        ...
        "The site's source code is released under the MIT License (open source). This does not grant any rights over the Pokémon trademarks: the MIT License applies only to the code written by the PrimeDex author.",
      ],
    },
    {
      id: 'sources',
      ...
      paragraphs: [
        'The data displayed by PrimeDex comes exclusively from public, community-driven third-party sources: PokéAPI (pokeapi.co, maintained by Paul Hallett) and TCGdex (api.tcgdex.net). Images are hosted by Scrydex and GitHub (raw.githubusercontent.com).',
    ...
    },
    {
      ...
      intro: 'You are authorized to use PrimeDex for personal, non-commercial, and informational purposes. The following are notably prohibited:',
      list: [
    ...
    },
    {
      ...
      paragraphs: [
        'PrimeDex is provided "as is" and "as available". The publisher strives to keep the site accessible 24/7, but does not guarantee uninterrupted availability.',
    ...
    },
    {
      ...
      list: [
        'PrimeDex cannot be held liable for indirect, incidental, special, or consequential damages resulting from the use of or inability to use the site.',
        'The publisher does not guarantee the accuracy, completeness, or timeliness of the displayed data.',
        'The publisher cannot be held liable for the content of third-party sites accessible via links from PrimeDex.',
    ...
    },
    {
      ...
      paragraphs: [
        'If you believe that any content displayed on PrimeDex infringes your rights (intellectual property, defamation, etc.), you can contact us at estdel3012@gmail.com specifying: the nature of the content at issue, its exact URL, your status (rights holder or representative), and any supporting evidence.',
...
const legalNotice: LegalDocument = {
  ...
  preamble:
    "PrimeDex is published by an individual on a personal, non-commercial basis. No legal entity stands behind this project: it is a fan project.",
  lastUpdated: 'June 4, 2026',
  effectiveDate: 'June 4, 2026',
  sections: [
    {
      ...
      intro: 'PrimeDex is published by:',
      table: {
        headers: ['Field', 'Value'],
        rows: [
          ['Name', 'PrimeDex (personal project name)'],
      ...
      callout: {
        type: 'warning',
        text: "In the absence of a legal entity, PrimeDex is not registered with the Trade and Companies Register (RCS) or the Crafts Register (RM). The publisher acts under their personal civil liability.",
      },
    },
    {
      id: 'host',
    ...
    },
    {
      ...
      paragraphs: [
        'PrimeDex is an online Pokédex and TCG card catalog, free, ad-free, and unmonetized. The site displays public data related to the Pokémon universe (numbers, types, statistics, sprites, cards) for strictly informational and recreational purposes.',
    ...
    },
    {
      ...
      paragraphs: [
        "PrimeDex is a non-commercial, independent, unaffiliated fan project. Trademarks, names, sprites, illustrations, and all other elements related to the Pokémon universe remain the exclusive property of Nintendo, Game Freak, Creatures Inc., and The Pokémon Company.",
...
const cookies: LegalDocument = {
  title: 'Cookie Policy',
  intro:
    'This policy details the cookies and trackers placed on your device when you browse PrimeDex, in accordance with CNIL guidelines and the GDPR.',
  preamble:
  ...
  sections: [
    {
      ...
      table: {
        ...
        rows: [
          ['primedex-lang', 'Remembers your preferred language', 'Strictly necessary (Art. 82 French Data Protection Act)', '1 year', 'PrimeDex'],
          ['tcg-user-state', 'Preserves your UI state on TCG pages (filters, sorts)', 'Strictly necessary', '1 year', 'PrimeDex'],
        ],
      },
      callout: {
        type: 'info',
      ...
      subsections: [
        {
          ...
          paragraphs: [
            'This cookie remembers the language in which you have chosen to display the site. Without it, you would see PrimeDex in the default language (English) on every visit. It contains no personal data: only an alphabetic value ("en", "fr", "de", etc.) is stored.',
          ],
          list: [
            'Publisher: PrimeDex.',
    ...
    },
    {
      ...
      paragraphs: [
        'PrimeDex does not set any third-party cookies. In particular:',
    ...
    },
    {
      ...
      paragraphs: [
        "In addition to cookies, PrimeDex uses local storage technologies (IndexedDB, localStorage) to preserve your preferences and usage data. This data remains on your device and is never transmitted to a server.",
