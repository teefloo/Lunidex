    ...
    },
    {
      ...
      subsections: [
        ...
        },
        {
          ...
          paragraphs: [
            'PrimeDex establece únicamente dos cookies estrictamente necesarias para el funcionamiento del servicio. Actualmente no se establece ninguna cookie de análisis, publicidad o perfilado. Para más información, consulte nuestra política de cookies.',
          ],
          list: [
  ...
  sections: [
    {
      ...
      intro: 'PrimeDex establece únicamente dos cookies, ambas estrictamente necesarias para el funcionamiento del servicio. No se establece ninguna cookie de análisis, publicidad o perfilado.',
      table: {
    ...
    },
    {
      ...
      list: [
        'No se instala ninguna cookie de análisis (Google Analytics, Matomo, Plausible, etc.).',
