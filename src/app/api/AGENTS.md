...
- Preserve graceful local-first behavior when Supabase is not configured; return the route's established unavailable response rather than throwing during module initialization.
