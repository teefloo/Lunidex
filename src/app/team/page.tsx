            ...
            {pokemonData.length > 0 && analysis && (
              ...
              >
                <div className="grid md:grid-cols-2 gap-8">
                  {/* Synergy Score */}
                  <div className="glass-panel p-6 md:p-8 rounded-sm flex flex-col h-full">
                    <div className="flex items-center justify-between gap-6 mb-8">
                      <div className="flex items-center gap-3">
                        <div className={cn("p-2 rounded-sm text-primary-foreground shadow-lg shadow-black/20", scoreColor)}>
