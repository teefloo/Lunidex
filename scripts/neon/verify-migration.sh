...
required_indexes(index_name) as (
  values
    ...
    ('quiz_attempts_user_daily_unique'),
...
required_functions(schema_name, function_name) as (
  values
    ...
    ('public', 'distinct_tcg_owned_count'),
    ('public', 'tcg_collection_cards_v3'),
    ('public', 'physical_tcg_collection_state_count'),
    ('public', 'physical_tcg_owned_count'),
    ('public', 'require_active_account'),
