...
const csp = [
  ...
  "img-src 'self' https://raw.githubusercontent.com https://pokeapi.co https://images.scrydex.com https://www.cardtrader.com https://images.pokemontcg.io https://assets.tcgdex.net https://images.tcgdex.net https://tcg.pokemon.com https://mcdn.pokemon.com https://dz3we2x72f7ol.cloudfront.net https://*.googleusercontent.com https://avatars.githubusercontent.com data: blob: https://api.tcgdex.net",
  "font-src 'self' data:",
  ...
  images: {
    ...
    remotePatterns: [
      ...
      },
      {
        ...
        pathname: '/expansions/30th-celebration/**',
      },
    ],
  },
  async rewrites() {
